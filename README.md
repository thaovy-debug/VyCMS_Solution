...
│   └── Entities/                # Định nghĩa 8 lớp thực thể cốt lõi
...
Thư mục `Entities` định nghĩa 8 bảng dữ liệu cốt lõi, phục vụ cho hai phân hệ nghiệp vụ chính là **Tin tức** và **Bán hàng**:
