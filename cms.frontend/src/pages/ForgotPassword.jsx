...
export default function ForgotPassword() {
        ...
        return (
            <main className="container py-5 flex-grow-1 d-flex justify-content-center align-items-center">
                <div className="card shadow-sm border-0 p-4" style={{ width: '100%', maxWidth: '450px', borderRadius: '12px' }}>
                    <h3 className="text-center mb-4 font-weight-bold" style={{ color: 'var(--zeychic-primary)' }}>KHÔI PHỤC MẬT KHẨU</h3>
                    <form onSubmit={handleResetPassword}>
                        ...
                        <button type="submit" className="btn btn-block text-white font-weight-bold py-2 mb-3" style={{ backgroundColor: 'var(--zeychic-primary)', borderRadius: '8px', width: '100%' }}>XÁC NHẬN</button>
                        <div className="text-center">
                            <span 
                                onClick={() => setShowOtpForm(false)} 
                                style={{ cursor: 'pointer', color: 'var(--zeychic-primary)', fontWeight: 'bold' }}
                            >
                                Quay lại nhập email
                            </span>
                        </div>
    ...
    return (
        <main className="container py-5 flex-grow-1 d-flex justify-content-center align-items-center">
            <div className="card shadow-sm border-0 p-4" style={{ width: '100%', maxWidth: '450px', borderRadius: '12px' }}>
                <h3 className="text-center mb-4 font-weight-bold" style={{ color: 'var(--zeychic-primary)' }}>QUÊN MẬT KHẨU</h3>
                ...
                <form onSubmit={handleForgotPassword}>
                    ...
                    <button type="submit" className="btn btn-block text-white font-weight-bold py-2 mb-3" style={{ backgroundColor: 'var(--zeychic-primary)', borderRadius: '8px', width: '100%' }}>GỬI MÃ OTP</button>
                    <div className="text-center">
                        <span className="text-muted">Nhớ mật khẩu? </span>
                        <Link to="/login" style={{ color: 'var(--zeychic-primary)', fontWeight: 'bold' }}>Quay lại đăng nhập</Link>
                    </div>
                </form>
            </div>
        </main>
